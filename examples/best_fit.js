...
function makeTextPanel() {
	...
	const warningTextBlock = new ThreeMeshUI.Text({
		content:
			"* Warning - The Best Fit functionality is computationally expensive and therefore should not be used if you intend to update the container size every frame. " +
